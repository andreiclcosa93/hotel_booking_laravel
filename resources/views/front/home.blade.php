        ...
        @foreach ($slide_all as $item)
            ...
            <div class="item" style="background-image:url({{ asset('uploads/'.$item->photo) }});">
                ...
                <div class="text">
                    ...
                    @if($item->button_text != '')
                        <div class="button">
                            <a href="{{ $item->button_url }}" target="_black">{{ $item->button_text }}</a>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <form action="{{ route('cart_submit') }}" method="post">
            ...
            <div class="inner">
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            <input type="number" name="adult" class="form-control" min="0" max="30" placeholder="Adults">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="form-group">
...
<div class="testimonial" style="background-image: url({{ asset('front/img/slide2.jpg') }})">
    <div class="bg"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
