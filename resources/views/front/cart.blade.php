...
<div class="page-top">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>{{ $global_page_data_third->cart_heading }}</h2>
            </div>
        </div>
    </div>
</div>
                            ...
                            for($i=0; $i<count($arr_cart_room_id); $i++) {
                                ...
                                @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('room_detail', $room_data->id) }}" class="room-name" style="color:#E75542; text-decoration: underline;">{{  $room_data->name }}</a>
                                        </td>
