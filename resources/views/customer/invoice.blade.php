        ...
        <div class="section-body">
            <div class="invoice">
                ...
                <div class="text-end d-print-none">
                    <a href="javascript:window.print();" class="btn btn-warning btn-icon icon-left text-white print-invoice-button" style="width:130px;"><i class="fa fa-print"></i> Print</a>
                    <a href="{{ route('customer_order_view') }}" class="btn btn-success " style="width:130px;">Back</a>
                </div>
            </div>
        </div>
    </div>
