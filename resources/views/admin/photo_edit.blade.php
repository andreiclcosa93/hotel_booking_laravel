    ...
    <div class="container-xxl flex-grow-1 container">
        ...
        <div class="col-12" style="margin-top:-35px;">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between mb-2">
                <h4 class="mb-sm-0">Photo Gallery Add</h4>
            </div>
            <div class="page-title-right mb-2">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin_photo_view') }}">Photo Gallery  View</a></li>
                    <li class="breadcrumb-item active text-info">Photo Gallery  Edit</li>
                </ol>
            </div>
        </div>
        ...
        <div class="card mb-4">
            ...
            <form action="{{ route('admin_photo_update', $photo_data->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                            <img src="{{ asset('uploads/'.$photo_data->photo) }}"  name="photo" id="showImage" class="rounded-circle avatar-lg img-thumbnail"
                            alt="profile-image">
                        </div>
                    </div>
                </div>
