    ...
    <div class="container-xxl flex-grow-1 container">
        ...
        <div class="col-12" style="margin-top:-35px;">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between mb-2">
                <h4 class="mb-sm-0">Cart Page</h4>
            </div>
            <div class="page-title-right mb-2">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active text-info">Cart Page</li>
                </ol>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="card mb-4">
            ...
            <form action="{{ route('admin_page_cart_update') }}" method="POST">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Cart Heading</label>
                    <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                            ...
                            <input
                                type="text"
                                name="cart_heading"
                                class="form-control @error('cart_heading') is-invalid @enderror"
                                id="cart_heading"
                                placeholder="Cart"
