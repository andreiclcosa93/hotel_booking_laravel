        ...
        <div class="col-12" style="margin-top:-35px;">
            ...
            <div class="page-title-right mb-2">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active text-info">Edit Room</li>
                </ol>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="card mb-4">
            ...
            <form action="{{ route('admin_room_update', $room_data->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                                ...
                                <div class="input-group input-group-merge">
                                    <img src="{{ asset('uploads/'.$room_data->featured_photo) }}"  name="photo" id="showImage" class="rounded-circle avatar-lg img-thumbnail"
                                    alt="profile-image">
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                            <textarea
                                ...
                                cols="20"
                                rows="2"
                            >{{ $room_data->description }}</textarea>
                        </div>
                        @error('description')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <label class="col-sm-6 form-label" for="basic-icon-default-phone">Room Size</label>
                        <div class="input-group input-group-merge">
                            <span id="basic-icon-default-message2" class="input-group-text">
                                <i class="bx bx-home"></i>
                            </span>
                    ...
                    <div class="col-sm-6">
                        <label class="col-sm-6 form-label" for="basic-icon-default-phone">Bedss</label>
                        <div class="input-group input-group-merge">
                            <span id="basic-icon-default-message2" class="input-group-text">
                                <i class="bx bx-bed"></i>
                            </span>
