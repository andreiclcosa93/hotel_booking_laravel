...
class AdminSlideController extends Controller
{
    ...
    public function slideCreate(Request $request) {
        ...
        return redirect()->back()->with('success', "slide is created successfull!");
    ...
    public function slideUpdate(Request $request, $id) {
        ...
        return redirect()->back()->with('success', "slide is updated successfull!");
    ...
    public function slideDelete($id) {
        ...
        return redirect()->back()->with('success', "slide is deleted successfull!");
